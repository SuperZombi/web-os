const Window = ({ win, children, theme, accentColor }) => {
	...
	return (
		<div ref={rootRef} onMouseDown={activate}
			...
			{showHeader && (<div className={`h-10 px-3 select-none flex items-center justify-center relative border-b ${dragabble && "cursor-move"} ${theme === 'dark' ? 'border-white/10 bg-white/5' : 'border-black/10 bg-white/40'}`} onMouseDown={dragabble ? ((e) => startInteraction(e, 'move')) : null}>
